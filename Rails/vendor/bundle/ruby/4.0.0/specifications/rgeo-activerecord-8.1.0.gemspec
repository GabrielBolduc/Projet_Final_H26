# -*- encoding: utf-8 -*-
# stub: rgeo-activerecord 8.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activerecord>.freeze, [">= 8.1".freeze, "< 8.2".freeze])
  s.add_runtime_dependency(%q<rgeo>.freeze, [">= 3.0".freeze])

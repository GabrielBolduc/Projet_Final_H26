# -*- encoding: utf-8 -*-
# stub: activerecord-mysql2spatial-adapter 0.4.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://dazuma.github.com/activerecord-mysql2spatial-adapter".freeze
  ...
  s.add_runtime_dependency(%q<rgeo-activerecord>.freeze, ["~> 0.4.5".freeze])
  s.add_runtime_dependency(%q<mysql2>.freeze, [">= 0.2.13".freeze])
end

# -*- encoding: utf-8 -*-
# stub: phonelib 0.10.16 ruby lib

Gem::Specification.new do |s|
  s.name = "phonelib".freeze
  s.version = "0.10.16".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "changelog_uri" => "https://github.com/daddyz/phonelib/releases/tag/v0.10.16" } if s.respond_to? :metadata=
